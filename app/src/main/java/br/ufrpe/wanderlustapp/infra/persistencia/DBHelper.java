...
public class DBHelper extends SQLiteOpenHelper {
    ...
    //Tabela Bar
    public static final String TABELA_BAR = "tb_bar";
    public static final String CAMPO_ID_BAR = "id";
    public static final String CAMPO_NOME_BAR = "nome_bar";
    public static final String CAMPO_DESCRICAO_BAR = "descricao";
    public static final String CAMPO_FK_CIDADE_BAR= "fk_cidade";
    ...
    private static final String[] TABELAS = {
            TABELA_PESSOA, TABELA_USUARIO, TABELA_PAIS, TABELA_CIDADE, TABELA_PRATO, TABELA_PONTO, TABELA_BAR, TABELA_PESSOA_PRATO, TABELA_PRATO_IMAGEM, TABELA_PONTO_IMAGEM
    };
    ...
    private void createTableBar(SQLiteDatabase db){
        String sqlTbPonto =
                "CREATE TABLE %1$s ( "  +
                        "  %2$s INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        "  %3$s TEXT NOT NULL, " +
                        ...
                        ");";
        sqlTbPonto = String.format(sqlTbPonto,
                TABELA_BAR, CAMPO_ID_BAR, CAMPO_NOME_BAR, CAMPO_DESCRICAO_BAR, CAMPO_FK_CIDADE_BAR, CAMPO_FK_CIDADE_BAR, TABELA_CIDADE, CAMPO_ID_CIDADE);
        db.execSQL(sqlTbPonto);
    }
