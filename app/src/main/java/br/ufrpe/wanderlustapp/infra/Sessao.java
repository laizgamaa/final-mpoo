...
public class Sessao {
    ...
    public void setBarLocal(BarLocal bar){setValue("sessao.BarLocal", bar);}

    public BarLocal getBarLocal(){return (BarLocal) values.get("sessao.BarLocal");}
    ...
    public void resetBar(){setBarLocal(null);}
