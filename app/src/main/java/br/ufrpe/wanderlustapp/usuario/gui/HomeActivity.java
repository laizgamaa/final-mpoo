...
import br.ufrpe.wanderlustapp.barLocal.gui.ListaBarActivity;
...
public class HomeActivity extends Activity implements
    ...
    private void defineIntent() {
        if(RecyclerViewItemPosition == 0){
            ...
            Intent iniciarGerenciarBar =
            new Intent(HomeActivity.this, ListaBarActivity.class);
            startActivity(iniciarGerenciarBar);
        }
